...
library stays your runtime validator, and one compiler types all three.
...
- [`src/main.ts`](src/main.ts): a consumer where each library validates at runtime, and the generated concrete types annotate the results.
